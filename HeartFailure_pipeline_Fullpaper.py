...
pipeline_numeric_feat= Pipeline([('round',adhoc_transf.ageRounder()),                                 
                                 ('scaler', MinMaxScaler())
                                 ])
...
df_results_clf_v41.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\Heart_Failure_Predictor\GridSearchCV_results\clf_v41_DMKD.xlsx',index=True)
...
#Saving the model
joblib.dump(clf_v41, r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\Heart_Failure_Predictor\GridSearchCV_results\clf_v41_DMKD.pkl', compress=1)
...
#load model to save time of fitting
clf_v411= joblib.load(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\Heart_Failure_Predictor\GridSearchCV_results\clf_v41.pkl')
...
df_results_clf_v41=pd.DataFrame(clf_v41.cv_results_)
# create an excel with the cross val resutls
df_results_clf_v41.to_excel(r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\Heart_Failure_Predictor\GridSearchCV_results\clf_v41_informationfusion.xlsx',index=True)
...
y_pred_41=clf_v41.predict(X_test)
#Saving the model
joblib.dump(clf_v41, r'C:\Users\k5000751\OneDrive - Epedu O365\SeAMK\GitHub\Heart_Failure_Predictor\GridSearchCV_results\clf_v41_informationfusion.pkl', compress=1)
